...
class Adidas1 extends StatelessWidget {
  const Adidas1({super.key});
  static String routeName = '/adidas1';
      ...
      child: Column(
        children: [
          ElevatedButton.icon(
            ...
            label: Text(
                'Checkout: ${counterModel.counter} - ${counterModel.formattedPrice}'),
            onPressed: () {
    ...
    return Container(
      ...
      child: const Column(
        ...
        children: [
          ...
          Text(
            "Style matters, and the adidas Superstar Golf shoes set a high standard on the course. \n\nFrom their iconic rubber-shell-toe design to their classic 3-Stripes style, these basketball-inspired golf shoes blend unmistakable adidas heritage with a leather upper and spikeless outsole that lets you roll from the green to the clubhouse and on to the barbecue with the same great style.Made with a series of recycled materials, this upper features at least 50% recycled content. \n\nThis product represents just one of our solutions to help end plastic waste.",
...
class ImageDetailProduct extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<String> images = [
      "assets/image/adidas/adidas1/2.jpg",
      "assets/image/adidas/adidas1/3.webp",
      "assets/image/adidas/adidas1/4.jpg",
      "assets/image/adidas/adidas1/5.webp",
      "assets/image/adidas/adidas1/6.jpg",
      "assets/image/adidas/adidas1/7.jpg"
    ];
