...
class Nike2 extends StatelessWidget {
  const Nike2({super.key});
  static String routeName = '/nike2';
...
class CounterModel8 extends ChangeNotifier {
  int counter = 0;
  int price = 0;
...
class TombolCheckout extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var counterModel8 = Provider.of<CounterModel8>(context);
    return Padding(
      ...
      child: Column(
        children: [
          ElevatedButton.icon(
            ...
            label: Text(
                'Checkout: ${counterModel8.counter} - ${counterModel8.formattedPrice}'),
            onPressed: () {
...
class ImageDetailProduct extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<String> images = [
      ...
      "assets/image/nike/nike2/2.webp",
      "assets/image/nike/nike2/3.webp",
      "assets/image/nike/nike2/4.webp",
      "assets/image/nike/nike2/5.webp",
      "assets/image/nike/nike2/6.webp",
      "assets/image/nike/nike2/7.webp",
    ];
...
class DeskripsiSingkat extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var counterMode8 = Provider.of<CounterModel8>(context);
    return Container(
                ...
                children: [
                  Container(
                    ...
                    child: IconButton(
                      ...
                      onPressed: counterMode8.decrementCounter,
                    ),
                  ),
                  Text(
                    "${counterMode8.counter}",
                  ...
                  Container(
                    ...
                    child: IconButton(
                      ...
                      onPressed: counterMode8.incrementCounter,
                    ),
                  ),
                ],
              ),
