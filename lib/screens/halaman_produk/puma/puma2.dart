...
class Puma2 extends StatelessWidget {
  const Puma2({super.key});
  static String routeName = '/puma2';
...
class CounterModel11 extends ChangeNotifier {
  int counter = 0;
  int price = 0;
...
class TombolCheckout extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var counterModel11 = Provider.of<CounterModel11>(context);
    return Padding(
      ...
      child: Column(
        children: [
          ElevatedButton.icon(
            ...
            label: Text(
                'Checkout: ${counterModel11.counter} - ${counterModel11.formattedPrice}'),
            onPressed: () {
      ...
      child: const Column(
        ...
        children: [
          ...
          Column(
            ...
            children: <Widget>[
              Text(
                "Some things never go out of style. The classic basketball-inspired silhouette of these sneakers is a look that's stood the test of time. Pair them with any outfit for retro vi...",
...
class ImageDetailProduct extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<String> images = [
      ...
      "assets/image/puma/puma2/2.webp",
      "assets/image/puma/puma2/3.webp",
      "assets/image/puma/puma2/4.webp",
      "assets/image/puma/puma2/5.webp",
      "assets/image/puma/puma2/6.webp",
      "assets/image/puma/puma2/7.webp",
    ];
...
class DeskripsiSingkat extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var counterMode11 = Provider.of<CounterModel11>(context);
    return Container(
                ...
                children: [
                  Container(
                    ...
                    child: IconButton(
                      ...
                      onPressed: counterMode11.decrementCounter,
                    ),
                  ),
                  Text(
                    "${counterMode11.counter}",
                  ...
                  Container(
                    ...
                    child: IconButton(
                      ...
                      onPressed: counterMode11.incrementCounter,
                    ),
                  ),
                ],
              ),
