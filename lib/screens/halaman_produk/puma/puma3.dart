...
class Puma3 extends StatelessWidget {
  const Puma3({super.key});
  static String routeName = '/puma3';
...
class CounterModel12 extends ChangeNotifier {
  int counter = 0;
  int price = 0;
...
class TombolCheckout extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var counterModel12 = Provider.of<CounterModel12>(context);
    return Padding(
      ...
      child: Column(
        children: [
          ElevatedButton.icon(
            ...
            label: Text(
                'Checkout: ${counterModel12.counter} - ${counterModel12.formattedPrice}'),
            onPressed: () {
      ...
      child: const Column(
        ...
        children: [
          ...
          Column(
            ...
            children: <Widget>[
              Text(
                "Get low on and off the court in these retro sneakers inspired by classic pop culture and basketball style. The casual throwback style captures the essence of old-school cool, ...",
              ...
              SizedBox(height: 10),
              Text(
                "Colour: PUMA White-PUMA Black-Malachite-PUMA Gold",
                style: TextStyle(
                  color: Colors.black,
                  fontSize: 14,
                  fontWeight: FontWeight.bold,
...
class ImageDetailProduct extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<String> images = [
      ...
      "assets/image/puma/puma3/2.webp",
      "assets/image/puma/puma3/3.webp",
      "assets/image/puma/puma3/4.webp",
      "assets/image/puma/puma3/5.webp",
      "assets/image/puma/puma3/6.webp",
      "assets/image/puma/puma3/7.webp",
    ];
...
class DeskripsiSingkat extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var counterMode12 = Provider.of<CounterModel12>(context);
    return Container(
                ...
                children: [
                  Container(
                    ...
                    child: IconButton(
                      ...
                      onPressed: counterMode12.decrementCounter,
                    ),
                  ),
                  Text(
                    "${counterMode12.counter}",
                  ...
                  Container(
                    ...
                    child: IconButton(
                      ...
                      onPressed: counterMode12.incrementCounter,
                    ),
                  ),
                ],
              ),
