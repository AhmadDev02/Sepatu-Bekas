...
class Converse2 extends StatelessWidget {
  const Converse2({super.key});
  static String routeName = '/converse2';
...
class CounterModel6 extends ChangeNotifier {
  int counter = 0;
  int price = 0;
...
class TombolCheckout extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var counterModel6 = Provider.of<CounterModel6>(context);
    return Padding(
      ...
      child: Column(
        children: [
          ElevatedButton.icon(
            ...
            label: Text(
                'Checkout: ${counterModel6.counter} - ${counterModel6.formattedPrice}'),
            onPressed: () {
...
class ImageDetailProduct extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<String> images = [
      ...
      "assets/image/converse/converse2/2.jpg",
      "assets/image/converse/converse2/3.jpg",
      "assets/image/converse/converse2/4.jpg",
      "assets/image/converse/converse2/5.jpg",
    ];
                ...
                children: [
                  Container(
                    ...
                    child: IconButton(
                      ...
                      onPressed: counterModel6.decrementCounter,
                    ),
                  ),
                  Text(
                    "${counterModel6.counter}",
                  ...
                  Container(
                    ...
                    child: IconButton(
                      ...
                      onPressed: counterModel6.incrementCounter,
                    ),
                  ),
                ],
              ),
